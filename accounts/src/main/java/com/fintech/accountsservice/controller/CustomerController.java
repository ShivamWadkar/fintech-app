...
@Tag(
        name = "REST APIs for Customers in Fintech",
        description = "REST APIs in Fintech to fetch Customer details"
)
@RestController
...
public class CustomerController {
    ...
    public ResponseEntity<CustomerDetailsDto> fetchCustomerDetails(@RequestHeader("fintech-correlation-id") String correlationId,
                                                                   @RequestParam
