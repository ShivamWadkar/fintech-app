...
@Tag(
        name = "CRUD REST APIs for Accounts in Fintech",
...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "Get build information that is deployed into accounts service"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Get java version that is deployed into accounts service"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
